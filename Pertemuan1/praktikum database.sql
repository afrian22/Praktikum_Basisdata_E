...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.bagian: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.bagian_karyawan: ~6 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.jabatan: ~5 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.jabatan_karyawan: ~17 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.karyawan: ~8 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.lokasi: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.penggajian: ~18 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.pengguna: ~8 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_peresensi_penggajian.presensi: ~552 rows (lebih kurang)
